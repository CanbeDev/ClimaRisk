  ...
  return (
    <div className="space-y-3 panel p-4">
      ...
      <div className="grid grid-cols-2 gap-3 pt-1">
        <div>
          <div className="text-[10px] uppercase tracking-wide text-muted">Projected BI loss</div>
          <div className="text-lg font-semibold tabular-nums text-over">{currency(biLoss)}</div>
        </div>
        <div>
          <div className="text-[10px] uppercase tracking-wide text-muted">Property + BI total</div>
          <div className="text-lg font-semibold tabular-nums text-pml">{currency(totalEstimatedLoss)}</div>
        </div>
      </div>
      ...
      <div className="border-t border-hair pt-2 text-[10px] leading-relaxed text-faint">
